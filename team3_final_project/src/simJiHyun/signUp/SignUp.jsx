        ...
        <div>
            ...
            <form className={"container"}>
                ...
                <div className={"row mt-4"}>
                    <div className={"col"}>
                        ...
                        <div className={"col d-flex flex-row justify-content-center gap-3"}>
                            <button type={"button"} className={"btn flex-fill py-3 shadow-sm"}>남</button>
                            <button type={"button"} className={"btn flex-fill py-3 shadow-sm"}>여</button>
                        </div>
                    </div>
                </div>
                ...
                <div className={"row mt-4"}>
                    <div className={"col"}>
                        <button type={"submit"}
                                className={"btn shadow-sm py-3 my-5 fw-bold text-light fs-4 w-100"}
