    ...
    return (
        <div className={"d-flex justify-content-start mb-0 gap-3"}>
            <p onClick={() => props.switchRW(true)}
               style={{
                   border: `1px solid ${props.isReservation ? "#FFD727" : "#A3A3A3"}`,
                   color: props.isReservation ? "#FFD727" : "#A3A3A3",
                   cursor: "pointer"
               }}
               className={"rounded-5 px-2"}>예약</p>
            <p onClick={() => props.switchRW(false)}
               style={{
                   border: `1px solid ${props.isReservation ? "#A3A3A3" : "#FFD727"}`,
                   color: props.isReservation ? "#A3A3A3" : "#FFD727",
                   cursor: "pointer"
               }}
