  ...
  return (
    <div className={'container py-4'}>
      ...
      <div>
        ...
        <div className={"mt-3"}>
          <Link className={'text-muted d-flex justify-content-between text-decoration-none'} to={'/bookmark'}>
            <p className="mb-1 fs-6 fs-sm-4 ms-1"><span className={'me-3'}><SpeechBubble/></span>북마크</p>
            <FontAwesomeIcon icon={faAngleRight} className={'me-2'}/>
          </Link>
        </div>
      </div>
